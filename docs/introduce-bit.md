...
## Idea stage: bit/x/collab

Git-native collaboration without GitHub/GitLab. PRs and Issues are stored as Git objects on a `_collab` branch and synced via fetch/push.
...
Mostly unimplemented; just an idea.
